...
(DATEADD('DAY', -3, CURRENT_DATE), 'CLOSED', DATEADD('DAY', -3, CURRENT_TIMESTAMP), 2,  DATEADD('DAY', -3, CURRENT_TIMESTAMP), DATEADD('DAY', -3, CURRENT_TIMESTAMP)),
(DATEADD('DAY', -2, CURRENT_DATE), 'CLOSED', DATEADD('DAY', -2, CURRENT_TIMESTAMP), 4,  DATEADD('DAY', -2, CURRENT_TIMESTAMP), DATEADD('DAY', -2, CURRENT_TIMESTAMP)),
